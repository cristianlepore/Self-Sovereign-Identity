...
Regarding RQ2, we examined different approaches to address our research questions by analyzing three examples from distinct fields: (1) open-source projects, (2) nutrient profiling, and (3) Where-to-be-born Index (formely the country Quality-of-Life index). While rating systems exist in other fields, for example University Ranking or cost of living, we study three examples in the field of software engineering, science, and social indicators of human welfare. We have chosen these three examples because to some extent, all include intangibles aspects such as political impacts of software, culturale aspects of food and products, individual freedom, and more. As measuring them requires defining metrics, our purpose is to learn the rationale that grounds some of the desition taken by designers when developing a rating model. It is not the purpose of this article to describe them deeply, rather it is a rule of thumb for the concepts that ground their work.
