...
Regarding RQ2, we examined different approaches to address our research questions by analyzing three examples from distinct fields: (1) open-source projects, (2) nutrient profiling, and (3) quality-of-life index. While rating systems exist in other fields, we study three examples because they are well-studied in the research community and have practical applications in everyday life. They also address aspects that vary across software engineering, science, and social indicators of human welfare. For each of them, we describe some of the research work and we mostly base on the methodology to provide an evaluation, to see if this can result into valuable ideas for our rating system for digital identity solutions.
